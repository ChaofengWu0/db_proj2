package application;// Q1 这个196给的是center ， model都相同的是两个数据还是一个数据
// Q2 输出的格式是大致样子相同就好了吗
// Q3 增删改查依据什么实现
// Q4  Q11是什么意思
...
public class Basic {
    ...
    private static URL propertyURL = Basic.class
...
//
    ...
    private static void stockIn() throws IOException, SQLException {
        ...
        String address_for_stock = "C:\\Users\\ll\\Desktop\\University\\dataBase\\proj\\db_proj2\\src\\in_stoke_test.csv";
    ...
    private static void deleteOrder() throws IOException, SQLException {
        ...
        PreparedStatement statement4 = null;
        PreparedStatement statement5 = null;
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\ll\\Desktop\\University\\dataBase\\proj\\db_proj2\\src\\delete_final.csv"));
        br.readLine();
        String line;
