...
//        con.commit();
    ...
    private void deleteOrder() throws IOException, SQLException {
        ...
        PreparedStatement statement4 = null;
        PreparedStatement statement5 = null;
        BufferedReader br = new BufferedReader(new FileReader("C:\\javaA\\javafx\\javafxStudy\\src\\data\\task34_delete_test_data_publish.tsv"));
        br.readLine();
        String line;
...
//                   "//                    \"from order_table)rank where contract_number=? and salesman_number=? and r=?");
    ...
    private void updateOrder() throws IOException, SQLException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("C:\\javaA\\javafx\\javafxStudy\\src\\data\\task34_update_test_data_publish.tsv"));
        br.readLine();
        String line;
    ...
    private void placeOrder() throws IOException, SQLException {
        PreparedStatement statement1 = null;
        PreparedStatement statement2 = null;
        String address_for_place_order = "C:\\javaA\\javafx\\javafxStudy\\src\\data\\task2_test_data_publish.csv";
    ...
    private void stockIn() throws IOException, SQLException {
        ...
        String address_for_stock = "C:\\javaA\\javafx\\javafxStudy\\src\\data\\task1_in_stoke_test_data_publish.csv";
