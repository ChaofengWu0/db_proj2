...
//        }                             //////////////////////pmy需要改
        ...
        defprop.put("user", "checker");//////////////////////pmy需要改
        defprop.put("password", "123456");//////////////////////pmy需要改
...
//        String number_for_Q12 = sc.next();
        ...
        String contract_number=sc.next();
...
//
    ...
    private static void stockIn() throws IOException, SQLException {
        ...
        String address_for_stock = "C:\\proj_temp\\proj2\\src\\release-testcase1\\task1_in_stoke_test_data_publish.csv";
    ...
    private static void placeOrder() throws IOException, SQLException {
        ...
        PreparedStatement statement2 = null;/////////////////////////////pmy需要改
        String address_for_place_order = "C:\\proj_temp\\proj2\\src\\release-testcase1\\task2_test_data_publish.csv";
    ...
    private static void updateOrder() throws IOException, SQLException {
        ...
        PreparedStatement statement6 = null;/////////////////////////////////pmy需要改
    ...
    private static void deleteOrder() throws IOException, SQLException {
        ...
        PreparedStatement statement3 = null;
        PreparedStatement statement4 = null;
        PreparedStatement statement5 = null;/////////////////////////////pmy需要改
    ...
    private static void load_original_data() throws SQLException {
        // 整个导入过程
        try {                                      ////////////////////////////pmy需要改
            String address1 = "C:\\proj_temp\\proj2\\src\\data\\center.csv";
            String address2 = "C:\\proj_temp\\proj2\\src\\data\\staff.csv";
            String address3 = "C:\\proj_temp\\proj2\\src\\data\\model.csv";
            String address4 = "C:\\proj_temp\\proj2\\src\\data\\enterprise.csv";
...
//            stmt6.addBatch();
    ...
    private static void  getAllStaffCount()throws SQLException{
        PreparedStatement statement1=null;
    ...
    private static void  getContractCount()throws SQLException{
        PreparedStatement statement1=null;
    ...
    private static void  getOrderCount()throws SQLException{
        PreparedStatement statement1=null;
    ...
    private static void  getNeverSoldProductCount()throws SQLException{
        PreparedStatement statement1=null;
    ...
    //目前理解的是，没有销售过的product_model指没有在任何一个中心销售过的product_model
    ...
    private static void getContractInfo(String contract_number) throws SQLException {
        PreparedStatement statement1 = null;
        PreparedStatement statement2 = null;
        ...
        while (resultSet2.getRow() != 0) {
            ...
            System.out.printf("%-20s %-25s %-15d %-5d %-5s %-5s\n", product_model,salesman ,  quantity,unit_price,estimate_delivery_date,lodgement_date);
            resultSet2.next();
        }
